...
VidaEnergiaBoard* VidaEnergiaBoard::instancia = nullptr;

VidaEnergiaBoard* VidaEnergiaBoard::getInstancia(SDL_Renderer* _renderer, int _posicionX, int _posicionY, int _ancho, int _alto, string _nombre, string _texto) {
    if (instancia == nullptr) {
        instancia = new VidaEnergiaBoard(_renderer, _posicionX, _posicionY, _ancho, _alto, _nombre, _texto);
    }

    return instancia;
}

VidaEnergiaBoard:: VidaEnergiaBoard(SDL_Renderer* _renderer, int _posicionX, int _posicionY, int _ancho, int _alto, string _nombre, string _texto) :Panel(_renderer, _posicionX, _posicionY, _ancho, _alto, _nombre, _texto) {
    renderer = _renderer;
